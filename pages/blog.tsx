...
const BlogPage = () => {
  return (
    <>
      <Navbar />
      <div className="px-3 lg:px-[20rem] pt-2 lg:pt-10">
        ...
        <div className="lg:px-10">
          <h2 className="lg:py-10 text-3xl font-medium">A team effort in a Box</h2>
          ...
          <p className="lg:py-16 text-xl font-bold italic text-gray-700">
      ...
      <div className="bg-slate-100">
          <div className="lg:px-40 lg:py-14">
            <h2 className="text-4xl font-medium text-gray-800">Related blog posts</h2>
          </div>
